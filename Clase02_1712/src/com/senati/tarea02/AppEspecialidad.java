...
public class AppEspecialidad {
	...
	public static void main(String[] args) {
		...
		Especialidad especialidad1 = new Especialidad("111","Ciencias");
		Especialidad especialidad2 = new Especialidad("112","Letras");
		Especialidad especialidad3 = new Especialidad("113","Artes");
